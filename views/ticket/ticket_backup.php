...
// alert(ticket_status_value);
  ...
  table_branch = $('#list').DataTable({
    ...
    "columnDefs": [{ "visible": false, "targets": [6,10]  },{ "orderable": false, "targets": 11 }],
    <?php }
    else
    {
    ?>
    "order": [[10,'desc'],[4 , 'desc']], 
    "columnDefs": [{ "visible": false, "targets": [6,7,8,9,10,11]  }],         
    <?php          
    }
    ?>  
    "serverSide": true, 
    ...
    buttons: [
       { extend: 'excelHtml5',
         exportOptions: {columns: [ 0,1,2,3,4,5,6,8,9]} /*, footer: true */},
              ],
