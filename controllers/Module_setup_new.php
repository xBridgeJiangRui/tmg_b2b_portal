...
class Module_setup_new extends CI_Controller
{
    ...
    public function user_group_form_old()
    {
        if ($this->session->userdata('loginuser') == true && $this->session->userdata('userid') != '') {
 ...
 ");
    ...
    public function resend_status()
    {
        ...
        $reset_url = 'https://tunasmanja.xbridge.my//index.php/Key_in/key_in?si=' . $reset_link->row('reset_guid') . '&ug=' . $user_guid;
        //print_r($reset_url); die;
        // echo $reset_url;die; https://tunasmanja.xbridge.my//
    ...
    public function user_group_duplicate()
    {
        ...
        // print_r($dp_group_from);

        // print_r($dp_group_to); die;
        ...
        {        
            ...
            foreach($select_from_query->result() as $row)
            {
                ...
                $check_group_exist = $this->db->query("SELECT * FROM lite_b2b.set_user_module WHERE user_group_guid = '$dp_group_to' AND module_group_guid = '$module_gorup_guid'")->result_array();
