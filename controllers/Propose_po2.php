...
class Propose_po2 extends CI_Controller {
    ...
    public function view_cost_summary(){
        ...
        $this->db->query("INSERT INTO lite_b2b.test_log (`module`, `url`, `post_data`, `time` ) VALUES ('start - view cost summary', '$to_shoot_url', '".json_encode($data)."', NOW())");
    ...
    public function generate_po_replenishment($customer_guid, $location, $user_guid, $supplier_code, $supplier_name, $delivery_date){
        ...
        // echo $to_shoot_url; echo '</br>';
        // print_r(json_encode($data)); die;

        $this->db->query("INSERT INTO lite_b2b.test_log (`module`, `url`, `post_data`, `time` ) VALUES ('start - generate po', '$to_shoot_url', '".json_encode($data)."', NOW())");
        ...
        $this->db->query("INSERT INTO lite_b2b.test_log (`module`, `url`, `post_data`, `time` ) VALUES ('end - generate po', '$to_shoot_url', '".json_encode($data)."', NOW())");
    ...
    public function view_propose_info(){
        ...
        $this->db->query("INSERT INTO lite_b2b.test_log (`module`, `url`, `time` ) VALUES ('start - view propose po', '$to_shoot_url', NOW())");
        ...
        $this->db->query("INSERT INTO lite_b2b.test_log (`module`, `url`, `time` ) VALUES ('end - view propose po', '$to_shoot_url', NOW())");
    ...
    public function view_header($return_response = 0, $filter_array = array(), $location = 0){
        ...
        $_SESSION['transmain_guid'] = isset($_SESSION['transmain_guid']) ? $_SESSION['transmain_guid'] : '';
        ...
        $this->db->query("INSERT INTO lite_b2b.test_log (`module`, `url`, `time` ) VALUES ('start - view header po', '$to_shoot_url', NOW())");
        ...
        $this->db->query("INSERT INTO lite_b2b.test_log (`module`, `url`, `time` ) VALUES ('end - view header po', '$to_shoot_url', NOW())");
